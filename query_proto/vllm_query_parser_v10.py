# -*- coding: utf-8 -*-
"""
10단계 프로토타입: vLLM(Qwen) 쿼리 파서 v10
v9 대비 변경점 - 회귀테스트에서 발견된 3개 신규 버그 대응:
  ...
  버그1과 유사 문제(문장에 없는 context를 "그럴듯해서" 지어내 추가하는 것)도 발견됨

대응:
  - 프롬프트: 각 버그에 대응하는 규칙/예시 추가
...
사용법:
    ...
    python3 vllm_query_parser_v10.py "야간 우천 시 보행자 횡단 장면"
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print('사용법: python3 vllm_query_parser_v10.py "검색하고 싶은 문장"')
        sys.exit(1)
