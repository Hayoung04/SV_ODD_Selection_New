# -*- coding: utf-8 -*-
"""
17단계 프로토타입: vLLM(Qwen) 쿼리 파서 v17
v16 대비 변경점 - "lost in the middle" 가설의 최소 변경 검증:
...
--- IMPORTANT REMINDER (read this last, right before parsing the user's sentence) ---
Every single field under "[lsd target tags]" — all 11 of them, no exceptions — requires you to
add {{"field":"time","value":"night"}} (with auto:true unless night is explicitly stated) whenever
that field is matched. This applies uniformly regardless of the field's specific meaning.
"""
