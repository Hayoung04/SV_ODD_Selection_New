# -*- coding: utf-8 -*-
"""
12단계 프로토타입: vLLM(Qwen) 쿼리 파서 v12
v11 대비 변경점 - 회귀테스트에서 발견된 2개 신규 버그 대응:
...
사용법:
    ...
    python3 vllm_query_parser_v12.py "야간 우천 시 보행자 횡단 장면"
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print('사용법: python3 vllm_query_parser_v12.py "검색하고 싶은 문장"')
        sys.exit(1)
